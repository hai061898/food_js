...
import * as product from "../controllers/product_controller";
import { upLoadsProducts } from "../helpers/multer";
...
router.post(
  "/add-new-products",
  [verifyToken, upLoadsProducts.array("image")],
...
router.get(
  "/search-product-for-name/:nameProduct",
  verifyToken,
  product.searchProductForName
);
router.get(
  "/search-product-for-category/:idCategory",
  verifyToken,
  product.searchProductsForCategory
);
